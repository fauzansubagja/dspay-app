                    ...
                    <div class="card-body">
                        <div class="dash-widget-header">
                            <div>
                                ...
                                <h6 class="text-muted">SMKN 4 Bandung</h6> </div>
                    ...
                    <div class="card-body">
                        <div class="dash-widget-header">
                            <div>
                                ...
                                <h6 class="text-muted">Rp.2.500.000.00</h6> </div>
            ...
            <div class="col-xl-3 col-sm-6 col-12">
                <div class="card board1 fill">
                    <div class="card-body">
                        <div class="dash-widget-header">
                            <div>
                                <h3 style="card_widget_header">Siswa</h3></h3>
                                <h6 class="text-muted">1,700</h6> </div>
            ...
            <div class="col-md-12 col-lg-6">
                <div class="card card-chart">
                    <div class="card-header">
                        <h4 class="card-title">Rekap Pembayaran</h4> </div>
                    <div class="card-body">
                        <div id="chart"></div>
                    </div>
                </div>
